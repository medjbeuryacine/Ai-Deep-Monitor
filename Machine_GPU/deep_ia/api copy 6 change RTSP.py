...
model_face = YOLO("yolov8n-face.pt")  # Assure-toi que ce modèle est bien présent
...
def stream_to_rtsp(youtube_url, rtsp_output):
    ...
    # Arrêter le processus ffmpeg précédent si en cours
    if ffmpeg_process and ffmpeg_process.poll() is None:
        print("🛑 Arrêt de l'ancien processus ffmpeg...")
...
async def detect(
    ...
    rtsp_url = "rtsp://127.0.0.1:8554/youtubelive"
...
if __name__ == '__main__':
    ...
    #     http://192.168.1.153:8000/api/detect?source=https://www.youtube.com/watch?v=Z-Nwo-ypKtM
    #     http://192.168.1.153:8000/api/detect?source=https://www.youtube.com/watch?v=6eJLHJgnUPk