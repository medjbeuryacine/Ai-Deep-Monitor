...
/* ****Pages Jimmy***** */
//OID Page
const SearchLive = Loadable(lazy(() => import('../views/pages/ysitech//oid/search_live')));
const SearchData = Loadable(lazy(() => import('../views/pages/ysitech//oid/search_data')));
// modifier par yacine
const SearchDoc = Loadable(lazy(() => import('../views/pages/ysitech/yacine/accueil')));


// Nicolas 
const DetectionBodyNicolas = Loadable(lazy(() => import('../views/pages/ysitech/yacine/detection_body_nicolas')));
const LogsPage = Loadable(lazy(() => import('../views/pages/ysitech/yacine/logspage')));
const Accueil = Loadable(lazy(() => import('../views/pages/ysitech/yacine/accueil')));
const ReconaissanceFaciale = Loadable(lazy(() => import('../views/pages/ysitech/yacine/reconaissancefaciale')));
// marwane :
const Tracagezonededetection = Loadable(lazy(() => import('../views/pages/ysitech/yacine/tracage_zone')));




// yacine :
const DetectVisage = Loadable(lazy(() => import('../views/pages/ysitech//oid/detect_vision')));
const Configuration_personnes = Loadable(lazy(() => import('../views/pages/ysitech/yacine/configuration_personnes')));
const Configuration_cameras = Loadable(lazy(() => import('../views/pages/ysitech/yacine/configuration_cameras')));
const Configuration_iadetection = Loadable(lazy(() => import('../views/pages/ysitech/yacine/configuration_iadetection')));
const Configuration_processeur = Loadable(lazy(() => import('../views/pages/ysitech/yacine/configuration_processeur')));
const FluxVideo = Loadable(lazy(() => import('../views/pages/ysitech/yacine/fluxvideo')));
const FluxVideoTest = Loadable(lazy(() => import('../views/pages/ysitech/yacine/fluxvideo_test')));
const CameraIp = Loadable(lazy(() => import('../views/pages/ysitech/yacine/camera_ip')));
const PersonnesPhotos = Loadable(lazy(() => import('../views/pages/ysitech/yacine/PersonnesPhotos')));
const ValidationImages = Loadable(lazy(() => import('../views/pages/ysitech/yacine/validation_images')));
...
//Manager page
const ManageInsert = Loadable(lazy(() => import('../views/pages/ysitech//manager/manage_insert')));
const ManageUpdate = Loadable(lazy(() => import('../views/pages/ysitech//manager/manage_update')));
const ManageMonitoring = Loadable(lazy(() => import('../views/pages/ysitech//manager/manage_monitoring')));


const MibManager = Loadable(lazy(() => import('../views/pages/ysitech//manager/manage_mib')));
const OidCustom = Loadable(lazy(() => import('../views/pages/ysitech//manager/manage_oid_custom')));
const Walksnmp = Loadable(lazy(() => import('../views/pages/ysitech//manager/manage_snmpwalk')));


const Configuration = Loadable(lazy(() => import('../views/pages/ysitech//manager/configuration')));

const Action = Loadable(lazy(() => import('../views/pages/ysitech//manager/action')));
const Profil = Loadable(lazy(() => import('../views/pages/ysitech//manager/profil')));
const Seuil = Loadable(lazy(() => import('../views/pages/ysitech//manager/seuil')));
const Utilisateur = Loadable(lazy(() => import('../views/pages/ysitech//manager/utilisateur')));

const Statut = Loadable(lazy(() => import('../views/pages/ysitech//manager/statut')));

const Alertlogs = Loadable(lazy(() => import('../views/pages/ysitech//manager/manage_alert_logs')));


const GraphPage = Loadable(lazy(() => import('../views/apps/chat/Graph')));
...
// front end pages
const Homepage = Loadable(lazy(() => import('../views/pages/ysitech-pages/Homepage')));
const About = Loadable(lazy(() => import('../views/pages/ysitech-pages/About')));
const Contact = Loadable(lazy(() => import('../views/pages/ysitech-pages/Contact')));
const Portfolio = Loadable(lazy(() => import('../views/pages/ysitech-pages/Portfolio')));
const PagePricing = Loadable(lazy(() => import('../views/pages/ysitech-pages/Pricing')));
const BlogPage = Loadable(lazy(() => import('../views/pages/ysitech-pages/Blog')));
const BlogPost = Loadable(lazy(() => import('../views/pages/ysitech-pages/BlogPost')));
...
const Router = [
  {
    ...
    element: <FullLayout />,
    children: [
      { path: '/', element: <Navigate to="/homepage" /> }, // /frontend-pages/homepage    /dashboards/modern


      /* page ysitech */
      //search OID
      { path: '/oid/live', exact: true, element: <SearchData /> },
      { path: '/oid/data', exact: true, element: <SearchLive /> },
      { path: '/oid/doc', exact: true, element: <SearchDoc /> },



      // // Nicolas route 
      { path: '/detection_body_nicolas', exact: true, element: <DetectionBodyNicolas /> },
      { path: '/logspage', exact: true, element: <LogsPage /> },
      { path: '/accueil', exact: true, element: <Accueil /> },
      { path: '/reconaissancefacielle', exact: true, element: <ReconaissanceFaciale /> },
      // marwan :
      { path: '/tracage_zone_de_detection', exact: true, element: <Tracagezonededetection /> },
      ...
      // yacine 
      { path: '/detectvisage', exact: true, element: <DetectVisage /> },
      { path: '/personnes', exact: true, element: <Configuration_personnes /> },
      { path: '/cameras', exact: true, element: <Configuration_cameras /> },
      { path: '/iadetection', exact: true, element: <Configuration_iadetection /> },
      { path: '/processeur', exact: true, element: <Configuration_processeur /> },
      { path: '/fluxvideo', exact: true, element: <FluxVideo /> },
      { path: '/fluxvideotest', exact: true, element: <FluxVideoTest /> },
      { path: '/cameraip', exact: true, element: <CameraIp /> },
      { path: '/personnes/:id/photos', exact: true, element: <PersonnesPhotos /> },
      { path: '/valimages', exact: true, element: <ValidationImages /> },
      ...
      //Manager
      { path: '/manage/insert', exact: true, element: <ManageInsert /> },
      { path: '/manage/update', exact: true, element: <ManageUpdate /> },
      { path: '/manage/monitoring', exact: true, element: <ManageMonitoring /> },


      { path: '/manage/mibs', exact: true, element: <MibManager /> },

      { path: '/manage/oid', exact: true, element: <OidCustom /> },
      { path: '/manage/walk', exact: true, element: <Walksnmp /> },
      
      { path: '/manage/configuration', exact: true, element: <Configuration /> },
      
      { path: '/manage/action', exact: true, element: <Action /> },
      { path: '/manage/profil', exact: true, element: <Profil /> },
      { path: '/manage/seuil', exact: true, element: <Seuil /> },
      { path: '/manage/users', exact: true, element: <Utilisateur /> },

      { path: '/manage/statut-survey', exact: true, element: <Statut /> },

      { path: '/manage/alert-log', exact: true, element: <Alertlogs /> },
